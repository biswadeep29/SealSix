...
//   const generateNewQrCode = useCallback(() => {
//     // Always generate the same fixed link
//     const newQrData = `https://escursio675.github.io/SIH_Authentication/`;
//     setQrData(newQrData);
//     setCountdown(QR_REFRESH_INTERVAL);
//     setQrExpired(false);
//   }, []);
...
//       setCountdown((prevCountdown) => {
//         if (prevCountdown <= 1) {
//           // Instead of regenerating, mark QR as expired
//           setQrExpired(true);
//           return 0;
//         }
//         return prevCountdown - 1;
...
export default function LiveSessionPage() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      ...
      setCountdown((prevCountdown) => {
        if (prevCountdown <= 1) {
          // Mark QR as expired and unmount it
          setQrExpired(true);
          setQrData(null);
          return 0;
        }
